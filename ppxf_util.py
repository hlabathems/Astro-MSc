...
#    lines = np.array([3726.03, 3728.82, 4101.76, 4340.47, 4861.33, 4958.92, 5006.84, 6300.30, 6548.03, 6583.41, 6562.80, 6716.47, 6730.85, 3869.9, 4364.4, 4687.0, 4387.93, 5015.68, 3967.79, 4364.21, 5876.])   

    lines = np.array([3726.03, 3728.82, 4101.76, 4340.47, 4861.33, 4958.92, 5006.84, 6300.30, 6548.03, 6583.41, 6562.80, 6716.47, 6730.85, 3868., 4685., 5876., 4363.])
    add_lines = np.linspace(6300., 6740., 100)
    lines = np.concatenate((lines, add_lines))
    dv = lines*0 + 800*2 #INI AKU UBAH LOH JADI DIKALI 2!!! # width/2 of masked gas emission region in km/s
    c = 299792.458 # speed of light in km/s
